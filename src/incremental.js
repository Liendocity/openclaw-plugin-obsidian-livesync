...
export class IncrementalSyncManager {
    ...
    lastBatchTime = 0;
    minBatchDelayMs;
    constructor(workspaceRoot, batchSize = 50, minBatchDelayMs = 1000) {
